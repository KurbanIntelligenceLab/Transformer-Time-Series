...
The pipeline of the proposed framework consists of data collection from transformers, Data Preprocessing, Data Partition, Model Training and Model Evaluation of
7 gas features across different forecast horizons.



<p align="center">
  <img src="pic/PAttnArch.png" alt="PAttn Architecture" width="30%"/>
</p>
